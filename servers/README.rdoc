...
== Thin
  sudo thin -C path/to/config.yml start
  sudo thin -C path/to/config.yml stop
= Mount Volume
Replace * with the name of the volume ID/Name
  aptitude -y install xfsprogs
  mkfs.xfs /dev/sd*
  mkdir -m 000 /data
  echo /dev/sd* /data xfs noatime 0 0 | sudo tee -a /etc/fstab
  mount /data
